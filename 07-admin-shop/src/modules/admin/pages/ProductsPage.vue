<template>
  <div class="bg-white px-5 py-2 rounded">
    <h1 class="text-3xl">Productes</h1>
      ...
      <div class="shadow overflow-hidden rounded border-b border-gray-200">
        <table class="min-w-full bg-white">
          <thead class="bg-gray-800 text-white">
            <tr>
              <th class="w-10 text-left py-3 px-4 uppercase font-semibold text-sm">Imatge</th>
              <th class="flex-1 text-left py-3 px-4 uppercase font-semibold text-sm">Títol</th>
              <th class="w-28 py-3 px-4 uppercase font-semibold text-sm">Preu</th>
              <th class="2-60 py-3 px-4 uppercase font-semibold text-sm">Talles</th>
            </tr>
          </thead>
