...
describe('<PokemonOptions />', () => {
  test('should render buttons with correct text', () => {
    const wrapper = mount(PokemonOptions, {
      props: { optionsList: options, blockSelection: false, correctAnswer: 1 },
    });
  ...
  test('should disabled buttons when blockSelection prop is true', async () => {
    const wrapper = mount(PokemonOptions, {
      props: { optionsList: options, blockSelection: true, correctAnswer: 1 },
    });
  ...
  test('should applied correct styling to buttons based on correct/incorrect answer', async () => {
    const correctAnswer = 2;

    const wrapper = mount(PokemonOptions, {
      props: { optionsList: options, blockSelection: true, correctAnswer: correctAnswer },
    });
